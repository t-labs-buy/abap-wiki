...
| `Developments/{WS}/` | WRICEF object records                                   | `{WS} - {ID} - {Object Name}.md`              |
...
`{WS}` is always the canonical workstream slug from `meta/entities.md`. Check the registry **before** creating any new workstream folder — see the Pre-Create Normalization Check in `CLAUDE.md`.
